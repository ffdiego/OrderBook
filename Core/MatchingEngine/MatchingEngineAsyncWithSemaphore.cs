...
{
    public class MatchingEngineAsyncWithSemaphore : IMatchingEngineAsync
    {
        ...
        public MatchingEngineAsyncWithSemaphore()
        {
        ...
        public async Task<List<Trade>> ProcessOrderAsync(Order newOrder)
        {
            ...
            SemaphoreSlim oppositeGate = GateOf(oppositeSide);
            await oppositeGate.WaitAsync().ConfigureAwait(false);
